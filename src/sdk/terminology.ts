...
export class Terminology extends ClientSDK {
    ...
    async add(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.AddTermsRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.AddTermsResponse$.inboundSchema.parse({
                        ...responseFields$,
                        Headers: this.unpackHeaders(response.headers),
                        CreateTermsResponse: val$,
                    });
                },
    ...
    async delete(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.DeleteTermsRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.DeleteTermsResponse$.inboundSchema.parse({
                        ...responseFields$,
                        Headers: this.unpackHeaders(response.headers),
                        DeleteResponse: val$,
                    });
    ...
    async find(
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) => operations.FindTermsRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.FindTermsResponse$.inboundSchema.parse({
                        ...responseFields$,
                        Headers: this.unpackHeaders(response.headers),
                        PaginatedResult_FullTermWithUser: val$,
                    });
                },
                "Response validation failed"
            );
    ...
    async update(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.UpdateTermsRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.UpdateTermsResponse$.inboundSchema.parse({
                        ...responseFields$,
                        Headers: this.unpackHeaders(response.headers),
                        CreateTermsResponse: val$,
                    });
