...
export class ModelCustomization extends ClientSDK {
    ...
    async create(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.CreateModelCustomizationRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.CreateModelCustomizationResponse$.inboundSchema.parse({
                        ...responseFields$,
                        Headers: this.unpackHeaders(response.headers),
                        ModelCustomization: val$,
                    });
                },
    ...
    async delete(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.DeleteModelCustomizationRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.DeleteModelCustomizationResponse$.inboundSchema.parse({
                        ...responseFields$,
                        Headers: this.unpackHeaders(response.headers),
                        object: val$,
                    });
    ...
    async get(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.GetModelCustomizationRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetModelCustomizationResponse$.inboundSchema.parse({
                        ...responseFields$,
                        Headers: this.unpackHeaders(response.headers),
                        ModelCustomization: val$,
                    });
    ...
    async list(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.ListModelCustomizationsRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.ListModelCustomizationsResponse$.inboundSchema.parse({
                        ...responseFields$,
                        Headers: this.unpackHeaders(response.headers),
                        CustomizationsResponse: val$,
                    });
                },
                "Response validation failed"
            );
